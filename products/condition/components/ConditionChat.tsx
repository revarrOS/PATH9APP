...
import { consultationPrepStore } from '@/products/condition/consultation-prep/services/consultation-prep.store';
...
export function ConditionChat({ additionalContext }: ConditionChatProps = {}) {
  ...
  const handleSaveQuestion = async (questionText: string, relatedTerms: string[]) => {
  ...
  const handleSend = async () => {
    ...
    try {
      await gemmaConversationService.addMessage(userMessage, 'condition');
      ...
      await gemmaConversationService.addMessage(assistantMessage, 'condition');
        ...
        {conversation.length === 0 && (
          <View style={styles.welcomeContainer}>
            <Text style={styles.welcomeText}>
              I can help you understand your clinical documents and prepare questions for your clinician.
            </Text>
            <Text style={styles.welcomeSubtext}>
              Ask me about terms in your letters, what changes mean, or help organizing questions.
            </Text>
          </View>
        )}
        ...
        initialQuestion={
          selectedSuggestion
            ? {
                ...
                relatedTerms: selectedSuggestion.relatedTerms || [],
              }
            : undefined
        }
      />
        ...
        <View style={styles.continuationModalOverlay}>
          <View style={styles.continuationModal}>
            ...
            <Text style={styles.continuationDescription}>
              Keep exploring your condition insights without interruption.
            </Text>
