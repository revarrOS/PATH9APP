    ...
    <View style={styles.card}>
      ...
      {question.relatedTerms && question.relatedTerms.length > 0 && (
        <View style={styles.termTags}>
          {question.relatedTerms.map((term, index) => (
            <View key={index} style={styles.termTag}>
      ...
      {question.sourceContext && (
        <View style={styles.context}>
          <Text style={styles.contextText}>
            {question.sourceContext.documentType && `${question.sourceContext.documentType}`}
            {question.sourceContext.documentDate && ` • ${question.sourceContext.documentDate}`}
            {question.sourceContext.clinicianName && ` • ${question.sourceContext.clinicianName}`}
          </Text>
        </View>
      )}
